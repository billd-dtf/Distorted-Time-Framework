...
{\small\itshape Independent Researcher, Austin, TX}\\[3pt]
...
whose geodesics are free fall. For a slow body $\int d\tau\approx\int\!\big(u-\tfrac{v^2}{2c^2u}\big)dt$;
...
It is tempting to read the clock term $\mathcal L_u=-\tfrac1{8\pi G}(\nabla u)^2-\rho u$ as an independent
scalar carrying gradient energy, whose momentum $\pi_u$ vanishes merely for want of a $\dot u$ term. That
...
$N_{\rm dof}=\tfrac12(20-2(6)-2)=3=2\text{ tensor}+1\text{ scalar}$ --- a breathing mode. That is a
khronometric theory, and it is precisely the one Chain~5 forbids.
...
{\small The SymPy/NumPy verification scripts named throughout are publicly available at
\url{https://github.com/billd-dtf/Distorted-Time-Framework}.\par}
