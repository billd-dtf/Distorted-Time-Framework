...
\texttt{DTF\_kerr\_premise\_oneoperator}, \texttt{DTF\_kerr\_deser\_closure}) are publicly available at the
release tagged \texttt{v1.0} (Version~8 of this trilogy); see the repository's README for a script-to-claim
index and run instructions.\par
\smallskip
